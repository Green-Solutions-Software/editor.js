...
class N extends Oe {
   ...
   */
  compose() {
    const e = d.make("div", N.CSS.wrapper), t = d.make("div", N.CSS.content), o = this.toolInstance.render();
        ...
        for (var w = 0; w < k.length; w++) {
          ...
          if (I) {
            ...
            for (C = 0; C < x.parts.length; C++)
              R.push(F(x.parts[C], m));
            a[x.id] = { id: x.id, refs: 1, parts: R };
          }
        }
      }
      function v(k, m) {
        for (var w = [], x = {}, I = 0; I < k.length; I++) {
          var C = k[I], R = m.base ? C[0] + m.base : C[0], B = { css: C[1], media: C[2], sourceMap: C[3] };
          x[R] ? x[R].parts.push(B) : w.push(x[R] = { id: R, parts: [B] });
        }
        return w;
      }
      function O(k, m) {
...
`);
      ...
      function F(k, m) {
        ...
        if (m.singleton) {
          var R = h++;
          w = u || (u = M(m)), x = ie.bind(null, w, R, !1), I = ie.bind(null, w, R, !0);
        } else
...
`);
      ...
      function ie(k, m, w, x) {
        ...
        if (k.styleSheet)
          ...
          var C = document.createTextNode(I), R = k.childNodes;
          R[m] && k.removeChild(R[m]), R.length ? k.insertBefore(C, R[m]) : k.appendChild(C);
        }
      }
    }, function(t, o) {
      t.exports = function(i) {
...
class Bs extends E {
   ...
   * @param block - block to move Toolbar near it
   */
  assignToolbarLeftPosition(e = this.Editor.BlockManager.currentBlock) {
    if (!e)
      return;
    const o = e.holder.querySelector(`.${N.CSS.content}`);
    o && (this.nodes.wrapper.style.left = `${Math.floor(o.offsetLeft)}px`);
  }
  /**
   * Enable bindings
   */
...
class ra extends E {
  ...
  composeBlock({
    ...
    const s = this.Editor.ReadOnly.isEnabled, r = this.Editor.Tools.blockTools.get(e), a = new N({
      id: o,
      data: t,
      tool: r,
      api: this.Editor.API,
...
class Be extends E {
  ...
  genInfoForMouseSelection() {
    ...
    const a = this.Editor.BlockManager.lastBlock.holder.querySelector("." + N.CSS.content), l = Number.parseInt(window.getComputedStyle(a).width, 10) / 2, c = t - l, u = t + l;
    return {
      index: r,
      leftPos: c,
      rightPos: u
...
class Ia extends E {
  ...
  make() {
    ...
    ]), this.nodes.redactor = d.make("div", this.CSS.editorZone), this.nodes.holder.offsetWidth < this.contentRect.width && this.nodes.wrapper.classList.add(this.CSS.editorWrapperNarrow), this.config.fullsize === !0 && this.nodes.wrapper.classList.add(this.CSS.editorWrapperFullsize), this.nodes.redactor.style.paddingBottom = this.config.minHeight + "px", this.nodes.wrapper.appendChild(this.nodes.redactor), this.nodes.holder.appendChild(this.nodes.wrapper), this.bindReadOnlyInsensitiveListeners();
  }
  /**
   * Appends CSS
   */
